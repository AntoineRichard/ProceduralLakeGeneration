...
class DemGenerator:
    ...
    def morph(self):
        """
        Creates a morphing map to apply ontop of the distance transform.
        """
    ...
    def loadContours(self):
        """
        Load the contours generated by the RandomLakeGenerator.
        """
    ...
    def makeMask(self):
        """
        Compute the mask to tell where the vegetation must be generated.
        """
        cnts = []
    ...
    def saturate(self, distance):
        """
        Saturate the map outside of the ROI.
        """
